    ...
    let protocol_message: ProtocolMessage = match mls_message_in.extract() {
        ...
        _ => {
            return Err(Status::invalid_argument(
                "Expected a PublicMessage or PrivateMessage for a commit",
            ));
        }
    };
...
impl MlsService for BackendMlsService {
    ...
    async fn generate_key_package(
        &self,
        request: Request<GenerateReq>,
    ) -> Result<Response<GenerateKeyPackageRes>, Status> {
        let hex = generate_key_package(&request.into_inner().client_id)?;
        Ok(Response::new(GenerateKeyPackageRes {
            key_package_hex: hex,
        }))
    }
    ...
    async fn process_commit(
        &self,
        request: Request<ProcessCommitReq>,
    ) -> Result<Response<Empty>, Status> {
        let req = request.into_inner();
    ...
    async fn serialize_tree(
        &self,
        request: Request<SerializeTreeReq>,
    ) -> Result<Response<SerializeTreeRes>, Status> {
        let req = request.into_inner();
    ...
    async fn export_shared_secret(
        &self,
        request: Request<ExportSecretReq>,
    ) -> Result<Response<ExportSecretRes>, Status> {
        let req = request.into_inner();
        let secret = export_shared_secret(&req.client_id, &req.group_id, &req.label)?;
        Ok(Response::new(ExportSecretRes {
            secret_bytes: secret,
        }))
    }
    ...
    async fn remove_member(
        &self,
        request: Request<RemoveReq>,
    ) -> Result<Response<RemoveRes>, Status> {
        let req = request.into_inner();
    ...
    async fn self_update(
        &self,
        request: Request<SelfUpdateReq>,
    ) -> Result<Response<SelfUpdateRes>, Status> {
        let req = request.into_inner();
